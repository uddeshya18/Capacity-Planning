...
if merc_file and qc_file:
    ...
    # 3. GLOBAL FILTER ENGINE (Impacts Growth & Tables)
    ...
    # 5. DEDUPLICATION & GROWTH (Now reflects filtered data)
    ...
    st.sidebar.metric(label="📈 Active Growth Rate", value=f"{site_growth_val * 100:.2f}%")
    ...
    st.info("Upload files. The 'Hide Inactive Tasks' toggle will now recalculate Growth % and Expected Tasks in real-time.")
